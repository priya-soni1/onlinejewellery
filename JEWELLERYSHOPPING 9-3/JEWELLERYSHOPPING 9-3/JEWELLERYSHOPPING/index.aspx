...
<body class="light">
    ...
    <div class="page-loader-wrapper">
        <div class="loader">
            <div class="m-t-30">
                <img class="loading-img-spin" src="adminResources/image/loading.png" alt="admin">
            </div>
            <p>Please wait...</p>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">
                    <img src="adminResources/image/logo.png" alt="" />
                ...
                <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="body">
                                <ul class="menu">
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="adminResources/image/user1.jpg" alt="">
                                            </span>
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="adminResources/image/user2.jpg" alt="">
                                            </span>
                                            <span class="menu-info">
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="adminResources/image/user3.jpg" alt="">
                                            </span>
                                            <span class="menu-info">
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="adminResources/image/user4.jpg" alt="">
                                            </span>
                                            <span class="menu-info">
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="adminResources/image/user5.jpg" alt="">
                                            </span>
                                            <span class="menu-info">
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="adminResources/image/user6.jpg" alt="">
                                            </span>
                                            <span class="menu-info">
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="adminResources/image/user7.jpg" alt="">
                                            </span>
                                            <span class="menu-info">
                                                <span class="menu-title">John Doe</span>
                                                <span class="menu-desc">
                    ...
                    <li class="dropdown user_profile">
                        <div class="dropdown-toggle" data-toggle="dropdown">
                            <img src="adminResources/image/user.jpg" alt="user">
                        </div>
                        <ul class="dropdown-menu pullDown">
                            <li class="body">
                    ...
                    <li>
                        <div class="sidebar-profile clearfix">
                            <div class="profile-img">
                                <img src="adminResources/image/user.jpg" alt="profile">
                            </div>
                                    ...
                                    <tbody>
                                            ...
                                            <td class="text-truncate">
                                                <ul class="list-unstyled order-list">
                                                    <li class="avatar avatar-sm"><img class="rounded-circle"
                                                            src="adminResources/image/user1.jpg" alt="user">
                                                    </li>
                                                    <li class="avatar avatar-sm"><img class="rounded-circle"
                                                            src="adminResources/image/user2.jpg" alt="user">
                                                    </li>
                                                    <li class="avatar avatar-sm"><img class="rounded-circle"
                                                            src="adminResources/image/user3.jpg" alt="user">
                                                    </li>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-truncate">
                                                <ul class="list-unstyled order-list">
                                                    <li class="avatar avatar-sm"><img class="rounded-circle"
                                                            src="adminResources/image/user4.jpg" alt="user">
                                                    </li>
                                                    <li class="avatar avatar-sm"><img class="rounded-circle"
                                                            src="adminResources/image/user5.jpg" alt="user">
                                                    </li>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-truncate">
                                                <ul class="list-unstyled order-list">
                                                    <li class="avatar avatar-sm"><img class="rounded-circle"
                                                            src="adminResources/image/user6.jpg" alt="user">
                                                    </li>
                                                    <li class="avatar avatar-sm"><img class="rounded-circle"
                                                            src="adminResources/image/user7.jpg" alt="user">
                                                    </li>
                                                    <li class="avatar avatar-sm"><img class="rounded-circle"
                                                            src="adminResources/image/user8.jpg" alt="user">
                                                    </li>
                                                    <li class="avatar avatar-sm"><span class="badge">+4</span>
                                                    </li>
                                                </ul>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-truncate">
                                                <ul class="list-unstyled order-list">
                                                    ...
                                                    <li class="avatar avatar-sm"><img class="rounded-circle"
                                                            src="adminResources/image/user9.jpg" alt="user">
                                                    </li>
    ...
    <script src="adminResources/js/echarts.js"></script>
